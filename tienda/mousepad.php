...
<body>
    ...
    <h2 class="titleP">MousePad</h2>
    <div class="ImagenesTienda">
        <figure>   
            <img src="../assets/img/mousepad/MOUSEPADRAZER.jfif" alt="">
            <div class="capa">
                <h3>MOUSEPAD RAZER</h3>
                <p>Tapete para mouse de videojuegos Razer Sphex V2 Gaming, videojuegos de perfil bajo Estándar</p>
            </div>
        </figure> 
        <figure>   
            <img src="../assets/img/mousepad/mousepad razer.jpg" alt="">
            <div class="capa">
        ...
        <figure>   
            <img src="../assets/img/mousepad/Mousepad thermaltake.jpg" alt="">
            <div class="capa">
                <h3>MOUSEPAD THERMALTAKE</h3>
                <p>Tt eSPORTS Draconem 16,8 millones de efectos RGB iluminados de tela edición Gaming Mouse Pad</p>
        </figure> 
        <figure>   
            <img src="../assets/img/mousepad/PAD XTECH XTA.jpg" alt="">
            <div class="capa">
                <h3>MOUSEPAD PAD XTECH XTA</h3>
                <p>XTECH Alfombrilla de ratón RGB para juegos, LED suave, extra extendida para teclado y ratón para ordenador grande</p>
            </div>
        </figure> 
    </div>
    <!-- redes sociales -->
