...
<body>
    ...
    <h2 class="titleP">Mouse</h2>
    <div class="ImagenesTienda">
        <figure>
            <img src="../assets/img/mouse/mouse corsair.jpg" alt="">
            <div class="capa">
                <h3>MOUSE CORSAIR</h3>
        ...
        <figure>   
            <img src="../assets/img/mouse/mouse optico.webp" alt="">
            <div class="capa">
                <h3>MOUSE OPTICO</h3>
                <p>mouse inalámbrico superligero para videojuegos, 18,000 CPI, sensor óptico TrueMove Air, diseño con resistencia al agua</p>
            </div>
        </figure> 
        <figure>   
            <img src="../assets/img/mouse/mouse primus.jpg" alt="">
            <div class="capa">
                <h3>MOUSE PRIMUS</h3>
                <p>Primus Gaming Mouse Gladius 10000S-Omron Switches-10000DPI-6 Programmable buttons-RGB LED lighting-On-board Memory</p>
            </div>
        </figure> 
        <figure>   
            <img src="../assets/img/mouse/mouse-gamer-ocelot.jpeg" alt="">
            <div class="capa">
                <h3>MOUSE OCELOT</h3>
                <p>Ratón para videojuegos con retroiluminación RGB de 16,8 millones de colores, agarre cómodo, 9 botones programables</p>
            </div>
        </figure> 
        <figure>   
            <img src="../assets/img/mouse/mouse-logitechg903.jpg" alt="">
            <div class="capa">
                <h3>MOUSE lOGITECH</h3>
                <p>Logitech G 903 LIGHTSPEED - Ratón inalámbrico para juegos con sensor Hero 25K, compatible con PowerPlay</p>
            </div>
        </figure> 
        <figure>   
            <img src="../assets/img/mouse/mouse-razer-abyssus.jpg" alt="">
            <div class="capa">
                <h3>MOUSE RAZER</h3>
                <p>RAZER ABYSSUS ESSENTIAL: Sensor Óptico de 7.200 DPI - 3 Botones de Hiperesponso - Alimentado por Razer Chroma </p>
            </div>
        </figure> 
    </div>
    <!-- redes sociales -->
